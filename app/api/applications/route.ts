  ...
  try {
    ...
    const result = await sql`
      INSERT INTO applications (
        ...
        total_experience, highest_education, position_applying_for,
    ...
    // Send notification email to careers@preciseanalytics.io
    try {
...
// GET - Fetch applications (for ATS dashboard)
export async function GET(request: NextRequest) {
  try {
    ...
    // Build query with Neon template literals
    let applications;
